...
class Fritadeira extends Produtos {
  ...
  Fritadeira(nome, qtde, preco, tipo_com, consumo_kw)
      : super(nome, qtde, preco, tipo_com, consumo_kw);
...
class ArCondicionado extends Produtos {
  ArCondicionado(nome, qtde, preco, tipo_com, consumo)
      : super(nome, qtde, preco, tipo_com, consumo);
  @override
  void ligar() {
