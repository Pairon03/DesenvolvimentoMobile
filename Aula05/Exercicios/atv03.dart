...
class Furadeira extends Maquina {
  Furadeira(String nome, int rot, double consumo)
      : super(nome, 1, rot, consumo);
...
class Torno extends Maquina {
  Torno(String nome, int eixos, int rotacao, double consumo)
      : super(nome, eixos, rotacao, consumo);
